...
out = cv2.VideoWriter('/run/media/sda1/front_video/output.avi',cv2.VideoWriter_fourcc('M', 'J', 'P', 'G'), 6.0, (640,480))
...
def test_front_video():
    ...
    while True:
        ...
        image, area, center = draw_res(frame, signs)
        print(center)
...
def test_sign():
    ...
    while True:
        ...
        image, a, center = draw_res(frame, signs)
        print(tasks)
        #print(center)
        #out.write(frame)
